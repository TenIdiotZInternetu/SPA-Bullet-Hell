...
class Minethrower(EnemySprite):
    def __init__(self):
        super().__init__()
        self.image_clean = pygame.transform.flip(pygame.image.load(str(ROOTDIR/'Assets'/'Ships'/ "Minethrower.png")).convert_alpha(), False, True)
    ...
    def shoot(self):
        bullet = GAME.level.queues[Bomb].get()
